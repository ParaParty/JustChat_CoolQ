...
begin
    exit(GenerateConfig(
        ...
        'RVIlXVslV09STERfRElTUExBWSVdJVNFTkRFUiU6ICVDT05URU5UJSIsCgkJCSJN'+
        'ZXNzYWdlX0ltYWdlQWx0ZXJuYXRpdmUiOiAiW0lNQUdFXSIsCgkJCSJQbGF5ZXJM'+
        'aXN0X0xheW91dCI6ICJbJVNFUlZFUiVdIFRoZXJlIGFyZSAlTk9XJS8lTUFYJSBw'+
        'bGF5ZXJzIG9ubGluZS4lUExBWUVSU19MSVNUJSIsCgkJCSJSZWdpc3RyYXRpb25f'+
        'b25saW5lIjogIlNlcnZlciAlTkFNRSUgaXMgbm93IG9ubGluZS4iLAoJCQkiUmVn'+
        'aXN0cmF0aW9uX29mZmxpbmUiOiAiU2VydmVyICVOQU1FJSBpcyBub3cgb2ZmbGlu'+
        'ZS4iCgkJfQoJfQp9'
    ));
end;
