...
function CQ_getGroupMemberInfoV2(AuthCode:longint;groupid,QQID:int64;nocache:longint):Pchar;
	stdcall; external 'CQP.dll' name 'CQ_getGroupMemberInfoV2';	
function CQ_getStrangerInfo(AuthCode:longint;QQID:int64;nocache:longint):Pchar;
...
Begin
	if nocache
		then data:=CQ_GetStrangerInfo(AuthCode,QQ,1)
		else data:=CQ_GetStrangerInfo(AuthCode,QQ,0);
...
Begin
	if nocache
		then return:=CQ_getGroupMemberInfoV2(AuthCode,groupid,QQID,1)
		else return:=CQ_getGroupMemberInfoV2(AuthCode,groupid,QQID,0);
